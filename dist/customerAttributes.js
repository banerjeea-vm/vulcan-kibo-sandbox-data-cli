...
exports.exportCustomerAttributes = exports.importCustomerAttributes = void 0;
var Spinner = require('cli-spinner').Spinner;
const utilites_1 = require("./utilites");
const profile_1 = require("./profile");
const nconf_1 = __importDefault(require("nconf"));
nconf_1.default.argv();
const dataFilePath = require('path').join(nconf_1.default.get('data') || './data', 'customer-attributes.jsonl');
...
const generateAttributes = async (attribute) => {
    try {
        ...
        if (error.originalError.statusCode === 409) {
            try {
                await customerAttributeClient.updateCustomerAttribute({ attributeFQN: attribute.attributeFQN }, { body: attribute });
...
async function importCustomerAttributes() {
...
exports.importCustomerAttributes = importCustomerAttributes;
async function exportCustomerAttributes() {
...
exports.exportCustomerAttributes = exportCustomerAttributes;
